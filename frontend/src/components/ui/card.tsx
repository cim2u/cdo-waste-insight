...
// Fix the import - remove .ts extension
...
function CardHeader({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn(
                "grid auto-rows-min grid-rows-[auto_auto] items-start gap-3.5 px-6 pt-6 has-data-[slot=card-action]:grid-cols-[1fr_auto] [.border-b]:pb-6",
                className,
            )}
            {...props}
        />
